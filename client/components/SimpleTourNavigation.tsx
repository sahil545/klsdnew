...
export default function SimpleTourNavigation() {
  const [isVisible, setIsVisible] = useState(false);

  useEffect(() => {
    const handleScroll = () => {
      // Simple visibility check - show after scrolling past hero
            ...
            {sections.map((section) => {
              ...
              return (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 whitespace-nowrap text-gray-600 hover:text-blue-600 hover:bg-blue-50 border border-transparent hover:border-blue-200"
                >
