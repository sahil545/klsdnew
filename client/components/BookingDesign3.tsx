...
export default function BookingDesign3({ 
  onReserveClick 
}: { 
  onReserveClick: () => void 
}) {
  ...
  return (
    <div className="w-full max-w-sm">
      {/* Modern Card with Split Sections */}
      <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
        
        {/* Top Section - Pricing & Features */}
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center bg-gray-50 rounded-lg p-1">
              ...
              <div className="flex-1 text-center">
                <div className="font-semibold text-gray-900">{guestCount}</div>
                <div className="text-xs text-gray-500">{guestCount === 1 ? 'guest' : 'guests'}</div>
              </div>
              <Button
                variant="ghost"
                size="sm"
