...
export default function BookingDesign6({ 
  onReserveClick 
}: { 
  onReserveClick: () => void 
}) {
  ...
  return (
    <div className="w-full max-w-sm">
      {/* Modern Card with Ocean Background Header */}
      <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
        
        {/* Top Section with Ocean Background */}
        <div className="relative p-6 text-white overflow-hidden">
          ...
          <div 
            ...
            style={{
              backgroundImage: 'url("https://cdn.builder.io/api/v1/image/assets%2F2a778920e8d54a37b1576086f79dd676%2F04a13ecb14db49a29892aec49c9d3466?format=webp&width=800")'
            }}
          />
          ...
          <div className="relative z-10">
            <div className="text-center mb-4">
              <div className="text-4xl font-bold mb-1 drop-shadow-lg">${basePrice}</div>
