        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              ...
              <div className="text-center bg-white/10 rounded-lg p-3 backdrop-blur-sm">
                <Waves className="w-5 h-5 text-orange-400 mx-auto mb-2" />
                <div className="text-sm text-white/90">Max Depth</div>
                <div className="font-semibold">{data.details.maxDepth}</div>
              </div>
              <div className="text-center bg-white/10 rounded-lg p-3 backdrop-blur-sm">
                <Shield className="w-5 h-5 text-orange-400 mx-auto mb-2" />
                <div className="text-sm text-white/90">Level</div>
                <div className="font-semibold">
                  {data.details.experienceLevel}
                </div>
              </div>
            </div>
            ...
            {/* Dive Sites Info */}
            <div className="mb-8 bg-white/10 rounded-lg p-4 backdrop-blur-sm">
